      ...
      <div className="max-w-screen-lg mx-auto flex items-center content-center justify-between  h-12">
        ...
        <div className="flex gap-2 flex-row items-center">
          ...
          <Link
            ...
            className="mx-2 px-2 py-2 rounded-full  hover:bg-onhover hover:scale-105 bg-primary text-white"
          >
            <Settings size={22} className="transition-all duration-300 " />
          </Link>

          <button className="mx-2 px-2 py-2 rounded-full bg-primary hover:bg-onhover hover:scale-105 text-white" onClick={logout}>
