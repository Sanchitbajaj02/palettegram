  ...
  if (!mounted) {
    ...
    return (
      <>
        <button
          type="button"
          className="px-2 py-2 md:flex fixed md:static block md:top-0 md:m-0 top-1 m-2 rounded-full hover:bg-primary-light hover:scale-105 bg-primary text-white themeButton"
        >
