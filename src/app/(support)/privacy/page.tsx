    ...
    <>
      ...
      <main className="max-w-screen-lg mx-auto my-4">
        ...
        <article>
          ...
          <p className="text-base my-1">For the purposes of this Privacy Policy:</p>
          <ul className="space-y-2 list-disc list-inside">
            ...
            <li>
              <strong>Website</strong> refers to Palettegram, accessible from{" "}
              <a
                href="https://palettegram.vercel.app"
        ...
        <article>
          ...
          <h4 className="text-lg my-4">Personal Data</h4>
          <p className="text-base my-1">
          ...
          <h4 className="text-lg my-4">Usage Data</h4>
          <p className="text-base my-1">
          ...
          <h4 className="text-lg my-4">Information from Third-Party Social Media Services</h4>
          <p className="text-base my-1">
          ...
          <h4 className="text-lg my-4">Tracking Technologies and Cookies</h4>
          <p className="text-base my-1">
          ...
          <h4 className="text-lg my-4">Business Transactions</h4>
          <p className="text-base my-1">
          ...
          <h4 className="text-lg my-4">Law enforcement</h4>
          <p className="text-base my-1">
          ...
          <h4 className="text-lg my-4">Other legal requirements</h4>
          <p className="text-base my-1">
