      ...
      <main className="max-w-screen-lg mx-auto my-4">
        ...
        <section>
          ...
          <p className="text-base my-1">
            ...
            use of Palettegram's Website, located at
            https://palettegram.vercel.app/.
          </p>

          <p className="text-base my-1">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Palettegram if you do not agree
          ...
          <p className="text-base my-1">
            We employ the use of cookies. By accessing Palettegram, you agreed
            to use cookies in agreement with the Palettegram's Privacy Policy.{" "}
          </p>
          ...
          <p className="text-base my-1">
            Unless otherwise stated, Palettegram and/or its licensors own the
            intellectual property rights for all material on Palettegram. All
            intellectual property rights are reserved. You may access this from
            Palettegram for your own personal use subjected to restrictions set
          ...
          <p className="text-base my-1">
            ...
            Palettegram does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Palettegram,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            Palettegram shall not be liable for the Comments or for any
          ...
          <p className="text-base my-1">
            Palettegram reserves the right to monitor all Comments and to remove
          ...
          <p className="text-base my-1">
            You hereby grant Palettegram a non-exclusive license to use,
          ...
          <p className="text-base my-1">
            ...
            visibility of the hyperlink compensates the absence of Palettegram;
          ...
          <p className="text-base my-1">
            ...
            sending an e-mail to Palettegram. Please include your name, your
          ...
          <p className="text-base my-1">Approved organizations may hyperlink to our Website as follows:</p>
          ...
          <p className="text-base my-1">
            No use of Palettegram's logo or other artwork will be allowed for
